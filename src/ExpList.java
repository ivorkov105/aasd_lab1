...
/**Итератор предоставляет схожий функционал с прямым итератором begin(), для этого реализуем next(), hasNext(), forEach(), у всех остальных
 * методов стандартная реализация интерфейса*/
    @Override
